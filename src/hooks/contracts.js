...
export const useGetERC20Contract = (address) => {
  ...
  const contract = address && library ? new Contract(address, ERC20Interface, library) : undefined
...
export const useGetPodContract = (address) => {
  ...
  const contract = address && library ? new Contract(address, PodInterface, library) : undefined
...
export const useGetPodManagerContract = (address) => {
  ...
  const contract =
    address && library ? new Contract(address, PodManagerInterface, library) : undefined
...
export const useGetCompoundPrizePoolContract = (address) => {
  ...
  const contract =
    address && library ? new Contract(address, CompoundPrizePoolInterface, library) : undefined
...
export const useGetPrizePoolFaucet = (address) => {
  ...
  const contract =
    address && library ? new Contract(address, PrizePoolFaucetInterface, library) : undefined
...
export const useGetTokenFaucetContract = (address) => {
  ...
  const contract =
    address && library ? new Contract(address, TokenFaucetInterface, library) : undefined
...
export const useGetTokenDropContract = (address) => {
  ...
  const contract =
    address && library ? new Contract(address, TokenDropInterface, library) : undefined
