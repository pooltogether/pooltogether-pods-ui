...
export type _MetaQuery = { __typename?: 'Query' } & {
  _meta?: Maybe<
    { __typename?: '_Meta_' } & Pick<_Meta_, 'deployment' | 'hasIndexingErrors'> & {
        block: { __typename?: '_Block_' } & Pick<_Block_, 'hash' | 'number'>
      }
  >
}
  ...
  account?: Maybe<
    { __typename?: 'Account' } & Pick<Account, 'id'> & {
        prizePoolAccounts: Array<
          { __typename?: 'PrizePoolAccount' } & Pick<
            PrizePoolAccount,
            'id' | 'timelockedBalance' | 'unlockTimestamp'
          > & {
              prizePool: { __typename?: 'PrizePool' } & Pick<
                PrizePool,
                | 'id'
                | 'deactivated'
                | 'owner'
        ...
        >
        controlledTokenBalances?: Maybe<
          Array<
            { __typename?: 'ControlledTokenBalance' } & Pick<
              ControlledTokenBalance,
              'id' | 'balance'
            > & {
                account: { __typename?: 'Account' } & Pick<Account, 'id'>
                controlledToken: { __typename?: 'ControlledToken' } & Pick<
                  ControlledToken,
                  'id' | 'name' | 'symbol' | 'decimals' | 'totalSupply' | 'numberOfHolders'
                >
              }
          >
        >
...
export type AwardedControlledTokenQuery = { __typename?: 'Query' } & {
  awardedControlledToken?: Maybe<
    { __typename?: 'AwardedControlledToken' } & Pick<
      AwardedControlledToken,
      'id' | 'winner' | 'amount'
    > & {
        token: { __typename?: 'ControlledToken' } & Pick<
          ControlledToken,
          'id' | 'name' | 'symbol' | 'decimals' | 'totalSupply' | 'numberOfHolders'
        > & {
            controller?: Maybe<
              { __typename?: 'PrizePool' } & Pick<
                PrizePool,
                | 'id'
                | 'deactivated'
                | 'owner'
        ...
        > & {
            ...
            awardedExternalErc20Tokens: Array<
              { __typename?: 'AwardedExternalErc20Token' } & Pick<
                AwardedExternalErc20Token,
                'id' | 'address' | 'name' | 'symbol' | 'decimals' | 'balanceAwarded' | 'winner'
              >
            >
            awardedExternalErc721Nfts: Array<
              { __typename?: 'AwardedExternalErc721Nft' } & Pick<
                AwardedExternalErc721Nft,
                'id' | 'address' | 'tokenIds' | 'winner'
              >
            >
          }
      }
...
export type AwardedControlledTokensQuery = { __typename?: 'Query' } & {
  awardedControlledTokens: Array<
    { __typename?: 'AwardedControlledToken' } & Pick<
      AwardedControlledToken,
      'id' | 'winner' | 'amount'
...
export type AwardedExternalErc20TokenQuery = { __typename?: 'Query' } & {
...
export type AwardedExternalErc20TokensQuery = { __typename?: 'Query' } & {
  awardedExternalErc20Tokens: Array<
    { __typename?: 'AwardedExternalErc20Token' } & Pick<
      AwardedExternalErc20Token,
      'id' | 'address' | 'name' | 'symbol' | 'decimals' | 'balanceAwarded' | 'winner'
...
export type AwardedExternalErc721NftQuery = { __typename?: 'Query' } & {
...
export type AwardedExternalErc721NftsQuery = { __typename?: 'Query' } & {
  awardedExternalErc721Nfts: Array<
    { __typename?: 'AwardedExternalErc721Nft' } & Pick<
      AwardedExternalErc721Nft,
      'id' | 'address' | 'tokenIds' | 'winner'
...
export type BalanceDripQuery = { __typename?: 'Query' } & {
  balanceDrip?: Maybe<
    { __typename?: 'BalanceDrip' } & Pick<
      BalanceDrip,
      | 'id'
      | 'sourceAddress'
      | 'measureToken'
      ...
      | 'deactivated'
    > & {
        comptroller: { __typename?: 'Comptroller' } & Pick<Comptroller, 'id' | 'owner'> & {
            players: Array<
              { __typename?: 'DripTokenPlayer' } & Pick<
                DripTokenPlayer,
                'id' | 'dripToken' | 'address' | 'balance'
              >
            >
            balanceDrips: Array<
              { __typename?: 'BalanceDrip' } & Pick<
        ...
        players: Array<
          { __typename?: 'BalanceDripPlayer' } & Pick<BalanceDripPlayer, 'id' | 'address'> & {
              balanceDrip: { __typename?: 'BalanceDrip' } & Pick<
                BalanceDrip,
                | 'id'
                | 'sourceAddress'
                | 'measureToken'
...
export type BalanceDripPlayerQuery = { __typename?: 'Query' } & {
...
export type BalanceDripPlayersQuery = { __typename?: 'Query' } & {
...
export type BalanceDripsQuery = { __typename?: 'Query' } & {
  balanceDrips: Array<
    { __typename?: 'BalanceDrip' } & Pick<
      BalanceDrip,
      | 'id'
...
export type CompoundPrizePoolQuery = { __typename?: 'Query' } & {
  compoundPrizePool?: Maybe<
    { __typename?: 'CompoundPrizePool' } & Pick<CompoundPrizePool, 'id' | 'cToken'>
  >
}
...
export type CompoundPrizePoolsQuery = { __typename?: 'Query' } & {
...
export type ComptrollerQuery = { __typename?: 'Query' } & {
  comptroller?: Maybe<
    { __typename?: 'Comptroller' } & Pick<Comptroller, 'id' | 'owner'> & {
        players: Array<
          { __typename?: 'DripTokenPlayer' } & Pick<
            DripTokenPlayer,
            'id' | 'dripToken' | 'address' | 'balance'
        ...
        volumeDrips: Array<
          ...
          > & {
              comptroller: { __typename?: 'Comptroller' } & Pick<Comptroller, 'id' | 'owner'>
              deposits: Array<
                { __typename?: 'VolumeDripPlayer' } & Pick<
                  VolumeDripPlayer,
                  'id' | 'address' | 'periodIndex' | 'balance'
                >
              >
              periods: Array<
                { __typename?: 'VolumeDripPeriod' } & Pick<
                  VolumeDripPeriod,
                  'id' | 'periodIndex' | 'totalSupply' | 'dripAmount' | 'endTime' | 'isDripping'
                >
              >
            }
        >
...
export type ComptrollersQuery = { __typename?: 'Query' } & {
  comptrollers: Array<
    { __typename?: 'Comptroller' } & Pick<Comptroller, 'id' | 'owner'> & {
        players: Array<
          { __typename?: 'DripTokenPlayer' } & Pick<
...
export type ControlledTokenQuery = { __typename?: 'Query' } & {
  controlledToken?: Maybe<
    { __typename?: 'ControlledToken' } & Pick<
      ControlledToken,
      'id' | 'name' | 'symbol' | 'decimals' | 'totalSupply' | 'numberOfHolders'
    > & {
        controller?: Maybe<
          { __typename?: 'PrizePool' } & Pick<
            ...
            | 'currentState'
          > & {
              prizeStrategy?: Maybe<{ __typename?: 'PrizeStrategy' } & Pick<PrizeStrategy, 'id'>>
              compoundPrizePool?: Maybe<
                { __typename?: 'CompoundPrizePool' } & Pick<CompoundPrizePool, 'id' | 'cToken'>
              >
              stakePrizePool?: Maybe<
                { __typename?: 'StakePrizePool' } & Pick<StakePrizePool, 'id' | 'stakeToken'>
              >
              yieldSourcePrizePool?: Maybe<
                { __typename?: 'YieldSourcePrizePool' } & Pick<
                  YieldSourcePrizePool,
                  'id' | 'yieldSource'
                >
              >
              sablierStream?: Maybe<{ __typename?: 'SablierStream' } & Pick<SablierStream, 'id'>>
              prizes: Array<
                { __typename?: 'Prize' } & Pick<
                  Prize,
                  | 'id'
              ...
              tokenCreditRates: Array<
                { __typename?: 'CreditRate' } & Pick<
                  CreditRate,
                  'id' | 'creditLimitMantissa' | 'creditRateMantissa'
                >
              >
              tokenCreditBalances: Array<
                { __typename?: 'CreditBalance' } & Pick<
                  CreditBalance,
                  'id' | 'balance' | 'timestamp' | 'initialized'
                >
              >
              prizePoolAccounts: Array<
                { __typename?: 'PrizePoolAccount' } & Pick<
...
export type ControlledTokenBalanceQuery = { __typename?: 'Query' } & {
  controlledTokenBalance?: Maybe<
    { __typename?: 'ControlledTokenBalance' } & Pick<ControlledTokenBalance, 'id' | 'balance'> & {
        account: { __typename?: 'Account' } & Pick<Account, 'id'> & {
            prizePoolAccounts: Array<
              { __typename?: 'PrizePoolAccount' } & Pick<
                PrizePoolAccount,
...
export type ControlledTokenBalancesQuery = { __typename?: 'Query' } & {
...
export type ControlledTokensQuery = { __typename?: 'Query' } & {
  controlledTokens: Array<
    { __typename?: 'ControlledToken' } & Pick<
      ControlledToken,
      'id' | 'name' | 'symbol' | 'decimals' | 'totalSupply' | 'numberOfHolders'
...
export type CreditBalanceQuery = { __typename?: 'Query' } & {
  creditBalance?: Maybe<
    { __typename?: 'CreditBalance' } & Pick<
      CreditBalance,
      'id' | 'balance' | 'timestamp' | 'initialized'
...
export type CreditBalancesQuery = { __typename?: 'Query' } & {
...
export type CreditRateQuery = { __typename?: 'Query' } & {
  creditRate?: Maybe<
    { __typename?: 'CreditRate' } & Pick<
      CreditRate,
      'id' | 'creditLimitMantissa' | 'creditRateMantissa'
...
export type CreditRatesQuery = { __typename?: 'Query' } & {
  creditRates: Array<
    { __typename?: 'CreditRate' } & Pick<
      CreditRate,
      'id' | 'creditLimitMantissa' | 'creditRateMantissa'
...
export type DripTokenPlayerQuery = { __typename?: 'Query' } & {
...
export type DripTokenPlayersQuery = { __typename?: 'Query' } & {
...
export type MultipleWinnersExternalErc20AwardQuery = {
  ...
  multipleWinnersExternalErc20Award?: Maybe<
    { __typename?: 'MultipleWinnersExternalErc20Award' } & Pick<
      MultipleWinnersExternalErc20Award,
      'id' | 'address' | 'name' | 'symbol' | 'decimals' | 'balanceAwarded'
    > & {
        prizeStrategy?: Maybe<
          { __typename?: 'MultipleWinnersPrizeStrategy' } & Pick<
          ...
          > & {
              ...
              externalErc721Awards: Array<
                { __typename?: 'MultipleWinnersExternalErc721Award' } & Pick<
...
export type MultipleWinnersPrizeStrategiesQuery = { __typename?: 'Query' } & {
...
export type MultipleWinnersPrizeStrategyQuery = { __typename?: 'Query' } & {
...
export type PrizeQuery = { __typename?: 'Query' } & {
  prize?: Maybe<
    { __typename?: 'Prize' } & Pick<
      Prize,
      | 'id'
...
export type PrizePoolQuery = { __typename?: 'Query' } & {
  prizePool?: Maybe<
    { __typename?: 'PrizePool' } & Pick<
      PrizePool,
      | 'id'
    ...
    > & {
        prizeStrategy?: Maybe<
          { __typename?: 'PrizeStrategy' } & Pick<PrizeStrategy, 'id'> & {
              singleRandomWinner?: Maybe<
                { __typename?: 'SingleRandomWinnerPrizeStrategy' } & Pick<
        ...
        >
        yieldSourcePrizePool?: Maybe<
          { __typename?: 'YieldSourcePrizePool' } & Pick<YieldSourcePrizePool, 'id' | 'yieldSource'>
        >
        sablierStream?: Maybe<
          { __typename?: 'SablierStream' } & Pick<SablierStream, 'id'> & {
              prizePool: { __typename?: 'PrizePool' } & Pick<
                PrizePool,
                | 'id'
                | 'deactivated'
...
export type PrizePoolAccountQuery = { __typename?: 'Query' } & {
...
export type PrizePoolAccountsQuery = { __typename?: 'Query' } & {
  prizePoolAccounts: Array<
    { __typename?: 'PrizePoolAccount' } & Pick<
      PrizePoolAccount,
      'id' | 'timelockedBalance' | 'unlockTimestamp'
...
export type PrizePoolsQuery = { __typename?: 'Query' } & {
  prizePools: Array<
    { __typename?: 'PrizePool' } & Pick<
      PrizePool,
      | 'id'
...
export type PrizeStrategiesQuery = { __typename?: 'Query' } & {
    ...
    { __typename?: 'PrizeStrategy' } & Pick<PrizeStrategy, 'id'> & {
        singleRandomWinner?: Maybe<
          ...
          > & {
              ...
              >
              externalErc20Awards: Array<
                { __typename?: 'SingleRandomWinnerExternalErc20Award' } & Pick<
                  SingleRandomWinnerExternalErc20Award,
                  'id' | 'address' | 'name' | 'symbol' | 'decimals'
                >
              >
              externalErc721Awards: Array<
                { __typename?: 'SingleRandomWinnerExternalErc721Award' } & Pick<
...
export type PrizeStrategyQuery = { __typename?: 'Query' } & {
  prizeStrategy?: Maybe<
    { __typename?: 'PrizeStrategy' } & Pick<PrizeStrategy, 'id'> & {
        singleRandomWinner?: Maybe<
          { __typename?: 'SingleRandomWinnerPrizeStrategy' } & Pick<
...
export type PrizesQuery = { __typename?: 'Query' } & {
  prizes: Array<
    { __typename?: 'Prize' } & Pick<
      Prize,
      | 'id'
...
export type SablierStreamQuery = { __typename?: 'Query' } & {
  sablierStream?: Maybe<
    { __typename?: 'SablierStream' } & Pick<SablierStream, 'id'> & {
        prizePool: { __typename?: 'PrizePool' } & Pick<
          PrizePool,
...
export type SablierStreamsQuery = { __typename?: 'Query' } & {
...
export type SingleRandomWinnerPrizeStrategiesQuery = {
  ...
  singleRandomWinnerPrizeStrategies: Array<
    { __typename?: 'SingleRandomWinnerPrizeStrategy' } & Pick<
      SingleRandomWinnerPrizeStrategy,
      'id' | 'owner' | 'rng' | 'prizePeriodSeconds' | 'prizePeriodStartedAt' | 'prizePeriodEndAt'
    > & {
        tokenListener?: Maybe<
          { __typename?: 'Comptroller' } & Pick<Comptroller, 'id' | 'owner'> & {
              players: Array<
...
export type SingleRandomWinnerPrizeStrategyQuery = { __typename?: 'Query' } & {
...
export type StakePrizePoolQuery = { __typename?: 'Query' } & {
  stakePrizePool?: Maybe<
    { __typename?: 'StakePrizePool' } & Pick<StakePrizePool, 'id' | 'stakeToken'>
  >
}
...
export type StakePrizePoolsQuery = { __typename?: 'Query' } & {
...
export type VolumeDripQuery = { __typename?: 'Query' } & {
  volumeDrip?: Maybe<
    { __typename?: 'VolumeDrip' } & Pick<
      VolumeDrip,
      | 'id'
    ...
    > & {
        ...
        deposits: Array<
          { __typename?: 'VolumeDripPlayer' } & Pick<
            ...
            'id' | 'address' | 'periodIndex' | 'balance'
          > & {
              volumeDrip: { __typename?: 'VolumeDrip' } & Pick<
                VolumeDrip,
                | 'id'
                | 'sourceAddress'
                | 'measureToken'
...
export type VolumeDripPeriodQuery = { __typename?: 'Query' } & {
...
export type VolumeDripPeriodsQuery = { __typename?: 'Query' } & {
...
export type VolumeDripPlayerQuery = { __typename?: 'Query' } & {
...
export type VolumeDripPlayersQuery = { __typename?: 'Query' } & {
...
export type VolumeDripsQuery = { __typename?: 'Query' } & {
  volumeDrips: Array<
    { __typename?: 'VolumeDrip' } & Pick<
      VolumeDrip,
      | 'id'
...
export type YieldSourcePrizePoolQuery = { __typename?: 'Query' } & {
  yieldSourcePrizePool?: Maybe<
    { __typename?: 'YieldSourcePrizePool' } & Pick<YieldSourcePrizePool, 'id' | 'yieldSource'>
  >
}
...
export type YieldSourcePrizePoolsQuery = { __typename?: 'Query' } & {
...
export const _MetaDocument = `
  ...
  _meta(block: $block) {
    ...
    `
export const use_MetaQuery = <TData = _MetaQuery, TError = unknown>(
...
>(
  ...
  useQuery<AwardedControlledTokenQuery, TError, TData>(
    ...
    fetcher<AwardedControlledTokenQuery, AwardedControlledTokenQueryVariables>(
      AwardedControlledTokenDocument,
      variables
    ),
    options
  )
...
>(
  ...
  useQuery<AwardedControlledTokensQuery, TError, TData>(
    ...
    fetcher<AwardedControlledTokensQuery, AwardedControlledTokensQueryVariables>(
      AwardedControlledTokensDocument,
      variables
    ),
    options
  )
...
>(
  ...
  useQuery<AwardedExternalErc20TokenQuery, TError, TData>(
    ...
    fetcher<AwardedExternalErc20TokenQuery, AwardedExternalErc20TokenQueryVariables>(
      AwardedExternalErc20TokenDocument,
      variables
    ),
    options
  )
...
>(
  ...
  useQuery<AwardedExternalErc20TokensQuery, TError, TData>(
    ...
    fetcher<AwardedExternalErc20TokensQuery, AwardedExternalErc20TokensQueryVariables>(
      AwardedExternalErc20TokensDocument,
      variables
    ),
    options
  )
...
>(
  ...
  useQuery<AwardedExternalErc721NftQuery, TError, TData>(
    ...
    fetcher<AwardedExternalErc721NftQuery, AwardedExternalErc721NftQueryVariables>(
      AwardedExternalErc721NftDocument,
      variables
    ),
    options
  )
...
>(
  ...
  useQuery<AwardedExternalErc721NftsQuery, TError, TData>(
    ...
    fetcher<AwardedExternalErc721NftsQuery, AwardedExternalErc721NftsQueryVariables>(
      AwardedExternalErc721NftsDocument,
      variables
    ),
    options
  )
export const BalanceDripDocument = `
  ...
  balanceDrip(id: $id, block: $block) {
    ...
    `
export const useBalanceDripQuery = <TData = BalanceDripQuery, TError = unknown>(
...
export const BalanceDripPlayerDocument = `
  ...
  balanceDripPlayer(id: $id, block: $block) {
    ...
    `
export const useBalanceDripPlayerQuery = <TData = BalanceDripPlayerQuery, TError = unknown>(
  ...
  useQuery<BalanceDripPlayerQuery, TError, TData>(
    ...
    fetcher<BalanceDripPlayerQuery, BalanceDripPlayerQueryVariables>(
      BalanceDripPlayerDocument,
      variables
    ),
    options
  )
export const BalanceDripPlayersDocument = `
  ...
  balanceDripPlayers(
    ...
    `
export const useBalanceDripPlayersQuery = <TData = BalanceDripPlayersQuery, TError = unknown>(
  ...
  useQuery<BalanceDripPlayersQuery, TError, TData>(
    ...
    fetcher<BalanceDripPlayersQuery, BalanceDripPlayersQueryVariables>(
      BalanceDripPlayersDocument,
      variables
    ),
    options
  )
export const BalanceDripsDocument = `
  ...
  balanceDrips(
    ...
    `
export const useBalanceDripsQuery = <TData = BalanceDripsQuery, TError = unknown>(
...
export const CompoundPrizePoolDocument = `
  ...
  compoundPrizePool(id: $id, block: $block) {
    ...
    `
export const useCompoundPrizePoolQuery = <TData = CompoundPrizePoolQuery, TError = unknown>(
  ...
  useQuery<CompoundPrizePoolQuery, TError, TData>(
    ...
    fetcher<CompoundPrizePoolQuery, CompoundPrizePoolQueryVariables>(
      CompoundPrizePoolDocument,
      variables
    ),
    options
  )
export const CompoundPrizePoolsDocument = `
  ...
  compoundPrizePools(
    ...
    `
export const useCompoundPrizePoolsQuery = <TData = CompoundPrizePoolsQuery, TError = unknown>(
  ...
  useQuery<CompoundPrizePoolsQuery, TError, TData>(
    ...
    fetcher<CompoundPrizePoolsQuery, CompoundPrizePoolsQueryVariables>(
      CompoundPrizePoolsDocument,
      variables
    ),
    options
  )
export const ComptrollerDocument = `
  ...
  comptroller(id: $id, block: $block) {
    ...
    `
export const useComptrollerQuery = <TData = ComptrollerQuery, TError = unknown>(
...
export const ComptrollersDocument = `
  ...
  comptrollers(
    ...
    `
export const useComptrollersQuery = <TData = ComptrollersQuery, TError = unknown>(
...
export const ControlledTokenDocument = `
  ...
  controlledToken(id: $id, block: $block) {
    ...
    `
export const useControlledTokenQuery = <TData = ControlledTokenQuery, TError = unknown>(
  ...
  useQuery<ControlledTokenQuery, TError, TData>(
    ...
    fetcher<ControlledTokenQuery, ControlledTokenQueryVariables>(
      ControlledTokenDocument,
      variables
    ),
    options
  )
...
>(
  ...
  useQuery<ControlledTokenBalanceQuery, TError, TData>(
    ...
    fetcher<ControlledTokenBalanceQuery, ControlledTokenBalanceQueryVariables>(
      ControlledTokenBalanceDocument,
      variables
    ),
    options
  )
...
>(
  ...
  useQuery<ControlledTokenBalancesQuery, TError, TData>(
    ...
    fetcher<ControlledTokenBalancesQuery, ControlledTokenBalancesQueryVariables>(
      ControlledTokenBalancesDocument,
      variables
    ),
    options
  )
export const ControlledTokensDocument = `
  ...
  controlledTokens(
    ...
    `
export const useControlledTokensQuery = <TData = ControlledTokensQuery, TError = unknown>(
  ...
  useQuery<ControlledTokensQuery, TError, TData>(
    ...
    fetcher<ControlledTokensQuery, ControlledTokensQueryVariables>(
      ControlledTokensDocument,
      variables
    ),
    options
  )
export const CreditBalanceDocument = `
  ...
  creditBalance(id: $id, block: $block) {
    ...
    `
export const useCreditBalanceQuery = <TData = CreditBalanceQuery, TError = unknown>(
...
export const CreditBalancesDocument = `
  ...
  creditBalances(
    ...
    `
export const useCreditBalancesQuery = <TData = CreditBalancesQuery, TError = unknown>(
...
export const CreditRateDocument = `
  ...
  creditRate(id: $id, block: $block) {
    ...
    `
export const useCreditRateQuery = <TData = CreditRateQuery, TError = unknown>(
...
export const CreditRatesDocument = `
  ...
  creditRates(
    ...
    `
export const useCreditRatesQuery = <TData = CreditRatesQuery, TError = unknown>(
...
export const DripTokenPlayerDocument = `
  ...
  dripTokenPlayer(id: $id, block: $block) {
    ...
    `
export const useDripTokenPlayerQuery = <TData = DripTokenPlayerQuery, TError = unknown>(
  ...
  useQuery<DripTokenPlayerQuery, TError, TData>(
    ...
    fetcher<DripTokenPlayerQuery, DripTokenPlayerQueryVariables>(
      DripTokenPlayerDocument,
      variables
    ),
    options
  )
export const DripTokenPlayersDocument = `
  ...
  dripTokenPlayers(
    ...
    `
export const useDripTokenPlayersQuery = <TData = DripTokenPlayersQuery, TError = unknown>(
  ...
  useQuery<DripTokenPlayersQuery, TError, TData>(
    ...
    fetcher<DripTokenPlayersQuery, DripTokenPlayersQueryVariables>(
      DripTokenPlayersDocument,
      variables
    ),
    options
  )
...
>(
  ...
  useQuery<MultipleWinnersExternalErc20AwardQuery, TError, TData>(
    ...
    fetcher<
      MultipleWinnersExternalErc20AwardQuery,
      MultipleWinnersExternalErc20AwardQueryVariables
    >(MultipleWinnersExternalErc20AwardDocument, variables),
    options
  )
...
>(
  ...
  useQuery<MultipleWinnersExternalErc20AwardsQuery, TError, TData>(
    ...
    fetcher<
      MultipleWinnersExternalErc20AwardsQuery,
      MultipleWinnersExternalErc20AwardsQueryVariables
    >(MultipleWinnersExternalErc20AwardsDocument, variables),
    options
  )
...
>(
  ...
  useQuery<MultipleWinnersExternalErc721AwardQuery, TError, TData>(
    ...
    fetcher<
      MultipleWinnersExternalErc721AwardQuery,
      MultipleWinnersExternalErc721AwardQueryVariables
    >(MultipleWinnersExternalErc721AwardDocument, variables),
    options
  )
...
>(
  ...
  useQuery<MultipleWinnersExternalErc721AwardsQuery, TError, TData>(
    ...
    fetcher<
      MultipleWinnersExternalErc721AwardsQuery,
      MultipleWinnersExternalErc721AwardsQueryVariables
    >(MultipleWinnersExternalErc721AwardsDocument, variables),
    options
  )
...
>(
  ...
  useQuery<MultipleWinnersPrizeStrategiesQuery, TError, TData>(
    ...
    fetcher<MultipleWinnersPrizeStrategiesQuery, MultipleWinnersPrizeStrategiesQueryVariables>(
      MultipleWinnersPrizeStrategiesDocument,
      variables
    ),
    options
  )
...
>(
  ...
  useQuery<MultipleWinnersPrizeStrategyQuery, TError, TData>(
    ...
    fetcher<MultipleWinnersPrizeStrategyQuery, MultipleWinnersPrizeStrategyQueryVariables>(
      MultipleWinnersPrizeStrategyDocument,
      variables
    ),
    options
  )
export const PrizeDocument = `
  ...
  prize(id: $id, block: $block) {
    ...
    `
export const usePrizeQuery = <TData = PrizeQuery, TError = unknown>(
...
export const PrizePoolDocument = `
  ...
  prizePool(id: $id, block: $block) {
    ...
    `
export const usePrizePoolQuery = <TData = PrizePoolQuery, TError = unknown>(
...
export const PrizePoolAccountDocument = `
  ...
  prizePoolAccount(id: $id, block: $block) {
    ...
    `
export const usePrizePoolAccountQuery = <TData = PrizePoolAccountQuery, TError = unknown>(
  ...
  useQuery<PrizePoolAccountQuery, TError, TData>(
    ...
    fetcher<PrizePoolAccountQuery, PrizePoolAccountQueryVariables>(
      PrizePoolAccountDocument,
      variables
    ),
    options
  )
export const PrizePoolAccountsDocument = `
  ...
  prizePoolAccounts(
    ...
    `
export const usePrizePoolAccountsQuery = <TData = PrizePoolAccountsQuery, TError = unknown>(
  ...
  useQuery<PrizePoolAccountsQuery, TError, TData>(
    ...
    fetcher<PrizePoolAccountsQuery, PrizePoolAccountsQueryVariables>(
      PrizePoolAccountsDocument,
      variables
    ),
    options
  )
...
export const PrizePoolsDocument = `
  ...
  prizePools(
    ...
    `
export const usePrizePoolsQuery = <TData = PrizePoolsQuery, TError = unknown>(
...
export const PrizeStrategiesDocument = `
  ...
  prizeStrategies(
    ...
    `
export const usePrizeStrategiesQuery = <TData = PrizeStrategiesQuery, TError = unknown>(
  ...
  useQuery<PrizeStrategiesQuery, TError, TData>(
    ...
    fetcher<PrizeStrategiesQuery, PrizeStrategiesQueryVariables>(
      PrizeStrategiesDocument,
      variables
    ),
    options
  )
export const PrizeStrategyDocument = `
  ...
  prizeStrategy(id: $id, block: $block) {
    ...
    `
export const usePrizeStrategyQuery = <TData = PrizeStrategyQuery, TError = unknown>(
...
export const PrizesDocument = `
  ...
  prizes(
    ...
    `
export const usePrizesQuery = <TData = PrizesQuery, TError = unknown>(
...
export const SablierStreamDocument = `
  ...
  sablierStream(id: $id, block: $block) {
    ...
    `
export const useSablierStreamQuery = <TData = SablierStreamQuery, TError = unknown>(
...
export const SablierStreamsDocument = `
  ...
  sablierStreams(
    ...
    `
export const useSablierStreamsQuery = <TData = SablierStreamsQuery, TError = unknown>(
...
>(
  ...
  useQuery<SingleRandomWinnerExternalErc20AwardQuery, TError, TData>(
    ...
    fetcher<
      SingleRandomWinnerExternalErc20AwardQuery,
      SingleRandomWinnerExternalErc20AwardQueryVariables
    >(SingleRandomWinnerExternalErc20AwardDocument, variables),
    options
  )
...
>(
  ...
  useQuery<SingleRandomWinnerExternalErc20AwardsQuery, TError, TData>(
    ...
    fetcher<
      SingleRandomWinnerExternalErc20AwardsQuery,
      SingleRandomWinnerExternalErc20AwardsQueryVariables
    >(SingleRandomWinnerExternalErc20AwardsDocument, variables),
    options
  )
...
>(
  ...
  useQuery<SingleRandomWinnerExternalErc721AwardQuery, TError, TData>(
    ...
    fetcher<
      SingleRandomWinnerExternalErc721AwardQuery,
      SingleRandomWinnerExternalErc721AwardQueryVariables
    >(SingleRandomWinnerExternalErc721AwardDocument, variables),
    options
  )
...
>(
  ...
  useQuery<SingleRandomWinnerExternalErc721AwardsQuery, TError, TData>(
    ...
    fetcher<
      SingleRandomWinnerExternalErc721AwardsQuery,
      SingleRandomWinnerExternalErc721AwardsQueryVariables
    >(SingleRandomWinnerExternalErc721AwardsDocument, variables),
    options
  )
...
>(
  ...
  useQuery<SingleRandomWinnerPrizeStrategiesQuery, TError, TData>(
    ...
    fetcher<
      SingleRandomWinnerPrizeStrategiesQuery,
      SingleRandomWinnerPrizeStrategiesQueryVariables
    >(SingleRandomWinnerPrizeStrategiesDocument, variables),
    options
  )
...
>(
  ...
  useQuery<SingleRandomWinnerPrizeStrategyQuery, TError, TData>(
    ...
    fetcher<SingleRandomWinnerPrizeStrategyQuery, SingleRandomWinnerPrizeStrategyQueryVariables>(
      SingleRandomWinnerPrizeStrategyDocument,
      variables
    ),
    options
  )
export const StakePrizePoolDocument = `
  ...
  stakePrizePool(id: $id, block: $block) {
    ...
    `
export const useStakePrizePoolQuery = <TData = StakePrizePoolQuery, TError = unknown>(
...
export const StakePrizePoolsDocument = `
  ...
  stakePrizePools(
    ...
    `
export const useStakePrizePoolsQuery = <TData = StakePrizePoolsQuery, TError = unknown>(
  ...
  useQuery<StakePrizePoolsQuery, TError, TData>(
    ...
    fetcher<StakePrizePoolsQuery, StakePrizePoolsQueryVariables>(
      StakePrizePoolsDocument,
      variables
    ),
    options
  )
export const VolumeDripDocument = `
  ...
  volumeDrip(id: $id, block: $block) {
    ...
    `
export const useVolumeDripQuery = <TData = VolumeDripQuery, TError = unknown>(
...
export const VolumeDripPeriodDocument = `
  ...
  volumeDripPeriod(id: $id, block: $block) {
    ...
    `
export const useVolumeDripPeriodQuery = <TData = VolumeDripPeriodQuery, TError = unknown>(
  ...
  useQuery<VolumeDripPeriodQuery, TError, TData>(
    ...
    fetcher<VolumeDripPeriodQuery, VolumeDripPeriodQueryVariables>(
      VolumeDripPeriodDocument,
      variables
    ),
    options
  )
export const VolumeDripPeriodsDocument = `
  ...
  volumeDripPeriods(
    ...
    `
export const useVolumeDripPeriodsQuery = <TData = VolumeDripPeriodsQuery, TError = unknown>(
  ...
  useQuery<VolumeDripPeriodsQuery, TError, TData>(
    ...
    fetcher<VolumeDripPeriodsQuery, VolumeDripPeriodsQueryVariables>(
      VolumeDripPeriodsDocument,
      variables
    ),
    options
  )
export const VolumeDripPlayerDocument = `
  ...
  volumeDripPlayer(id: $id, block: $block) {
    ...
    `
export const useVolumeDripPlayerQuery = <TData = VolumeDripPlayerQuery, TError = unknown>(
  ...
  useQuery<VolumeDripPlayerQuery, TError, TData>(
    ...
    fetcher<VolumeDripPlayerQuery, VolumeDripPlayerQueryVariables>(
      VolumeDripPlayerDocument,
      variables
    ),
    options
  )
export const VolumeDripPlayersDocument = `
  ...
  volumeDripPlayers(
    ...
    `
export const useVolumeDripPlayersQuery = <TData = VolumeDripPlayersQuery, TError = unknown>(
  ...
  useQuery<VolumeDripPlayersQuery, TError, TData>(
    ...
    fetcher<VolumeDripPlayersQuery, VolumeDripPlayersQueryVariables>(
      VolumeDripPlayersDocument,
      variables
    ),
    options
  )
export const VolumeDripsDocument = `
  ...
  volumeDrips(
    ...
    `
export const useVolumeDripsQuery = <TData = VolumeDripsQuery, TError = unknown>(
...
export const YieldSourcePrizePoolDocument = `
  ...
  yieldSourcePrizePool(id: $id, block: $block) {
    ...
    `
export const useYieldSourcePrizePoolQuery = <TData = YieldSourcePrizePoolQuery, TError = unknown>(
  ...
  useQuery<YieldSourcePrizePoolQuery, TError, TData>(
    ...
    fetcher<YieldSourcePrizePoolQuery, YieldSourcePrizePoolQueryVariables>(
      YieldSourcePrizePoolDocument,
      variables
    ),
    options
  )
export const YieldSourcePrizePoolsDocument = `
  ...
  yieldSourcePrizePools(
    ...
    `
export const useYieldSourcePrizePoolsQuery = <TData = YieldSourcePrizePoolsQuery, TError = unknown>(
  ...
  useQuery<YieldSourcePrizePoolsQuery, TError, TData>(
    ...
    fetcher<YieldSourcePrizePoolsQuery, YieldSourcePrizePoolsQueryVariables>(
      YieldSourcePrizePoolsDocument,
      variables
    ),
    options
  )
