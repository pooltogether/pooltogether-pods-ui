...
export type _MetaQuery = { __typename?: "Query" } & {
  _meta?: Maybe<
    { __typename?: "_Meta_" } & Pick<
      _Meta_,
      "deployment" | "hasIndexingErrors"
...
export type BalanceDripQuery = { __typename?: "Query" } & {
  balanceDrip?: Maybe<
    { __typename?: "BalanceDrip" } & Pick<
      ...
      | "deactivated"
    > & {
        comptroller: { __typename?: "Comptroller" } & Pick<
          Comptroller,
          "id" | "owner"
        > & {
            players: Array<
        ...
        players: Array<
          { __typename?: "BalanceDripPlayer" } & Pick<
            BalanceDripPlayer,
            "id" | "address"
          > & {
...
export type CompoundPrizePoolQuery = { __typename?: "Query" } & {
  compoundPrizePool?: Maybe<
    { __typename?: "CompoundPrizePool" } & Pick<
      CompoundPrizePool,
      "id" | "cToken"
    >
  >;
        ...
        controller?: Maybe<
          ...
          > & {
              ...
              stakePrizePool?: Maybe<
                { __typename?: "StakePrizePool" } & Pick<
                  StakePrizePool,
                  "id" | "stakeToken"
                >
              >;
...
>(
  ...
  useQuery<AwardedControlledTokensQuery, TError, TData>(
    ...
    fetcher<
      AwardedControlledTokensQuery,
      AwardedControlledTokensQueryVariables
    >(AwardedControlledTokensDocument, variables),
    options
  );
...
>(
  ...
  useQuery<AwardedExternalErc20TokenQuery, TError, TData>(
    ...
    fetcher<
      AwardedExternalErc20TokenQuery,
      AwardedExternalErc20TokenQueryVariables
    >(AwardedExternalErc20TokenDocument, variables),
    options
  );
...
>(
  ...
  useQuery<AwardedExternalErc20TokensQuery, TError, TData>(
    ...
    fetcher<
      AwardedExternalErc20TokensQuery,
      AwardedExternalErc20TokensQueryVariables
    >(AwardedExternalErc20TokensDocument, variables),
    options
  );
...
>(
  ...
  useQuery<AwardedExternalErc721NftQuery, TError, TData>(
    ...
    fetcher<
      AwardedExternalErc721NftQuery,
      AwardedExternalErc721NftQueryVariables
    >(AwardedExternalErc721NftDocument, variables),
    options
  );
...
>(
  ...
  useQuery<AwardedExternalErc721NftsQuery, TError, TData>(
    ...
    fetcher<
      AwardedExternalErc721NftsQuery,
      AwardedExternalErc721NftsQueryVariables
    >(AwardedExternalErc721NftsDocument, variables),
    options
  );
...
export const useBalanceDripQuery = <TData = BalanceDripQuery, TError = unknown>(
  ...
  useQuery<BalanceDripQuery, TError, TData>(
    ...
    fetcher<BalanceDripQuery, BalanceDripQueryVariables>(
      BalanceDripDocument,
      variables
    ),
    options
...
>(
  ...
  useQuery<BalanceDripsQuery, TError, TData>(
    ...
    fetcher<BalanceDripsQuery, BalanceDripsQueryVariables>(
      BalanceDripsDocument,
      variables
    ),
    options
  );
...
export const useComptrollerQuery = <TData = ComptrollerQuery, TError = unknown>(
  ...
  useQuery<ComptrollerQuery, TError, TData>(
    ...
    fetcher<ComptrollerQuery, ComptrollerQueryVariables>(
      ComptrollerDocument,
      variables
    ),
    options
...
>(
  ...
  useQuery<ComptrollersQuery, TError, TData>(
    ...
    fetcher<ComptrollersQuery, ComptrollersQueryVariables>(
...
>(
  ...
  useQuery<ControlledTokenBalancesQuery, TError, TData>(
    ...
    fetcher<
      ControlledTokenBalancesQuery,
      ControlledTokenBalancesQueryVariables
    >(ControlledTokenBalancesDocument, variables),
    options
  );
...
>(
  ...
  useQuery<CreditBalanceQuery, TError, TData>(
    ...
    fetcher<CreditBalanceQuery, CreditBalanceQueryVariables>(
...
>(
  ...
  useQuery<CreditBalancesQuery, TError, TData>(
    ...
    fetcher<CreditBalancesQuery, CreditBalancesQueryVariables>(
      CreditBalancesDocument,
      variables
    ),
    options
  );
...
export const useCreditRateQuery = <TData = CreditRateQuery, TError = unknown>(
  ...
  useQuery<CreditRateQuery, TError, TData>(
    ...
    fetcher<CreditRateQuery, CreditRateQueryVariables>(
      CreditRateDocument,
      variables
    ),
    options
...
export const useCreditRatesQuery = <TData = CreditRatesQuery, TError = unknown>(
  ...
  useQuery<CreditRatesQuery, TError, TData>(
    ...
    fetcher<CreditRatesQuery, CreditRatesQueryVariables>(
      CreditRatesDocument,
      variables
    ),
    options
...
>(
  ...
  useQuery<MultipleWinnersPrizeStrategiesQuery, TError, TData>(
    ...
    fetcher<
      MultipleWinnersPrizeStrategiesQuery,
      MultipleWinnersPrizeStrategiesQueryVariables
    >(MultipleWinnersPrizeStrategiesDocument, variables),
    options
  );
...
>(
  ...
  useQuery<MultipleWinnersPrizeStrategyQuery, TError, TData>(
    ...
    fetcher<
      MultipleWinnersPrizeStrategyQuery,
      MultipleWinnersPrizeStrategyQueryVariables
    >(MultipleWinnersPrizeStrategyDocument, variables),
    options
  );
...
export const usePrizePoolQuery = <TData = PrizePoolQuery, TError = unknown>(
  ...
  useQuery<PrizePoolQuery, TError, TData>(
    ["prizePool", variables],
    fetcher<PrizePoolQuery, PrizePoolQueryVariables>(
      PrizePoolDocument,
      variables
    ),
    options
...
export const usePrizePoolsQuery = <TData = PrizePoolsQuery, TError = unknown>(
  ...
  useQuery<PrizePoolsQuery, TError, TData>(
    ...
    fetcher<PrizePoolsQuery, PrizePoolsQueryVariables>(
      PrizePoolsDocument,
      variables
    ),
    options
...
>(
  ...
  useQuery<PrizeStrategyQuery, TError, TData>(
    ...
    fetcher<PrizeStrategyQuery, PrizeStrategyQueryVariables>(
      PrizeStrategyDocument,
      variables
    ),
    options
  );
...
>(
  ...
  useQuery<SablierStreamQuery, TError, TData>(
    ...
    fetcher<SablierStreamQuery, SablierStreamQueryVariables>(
      SablierStreamDocument,
      variables
    ),
    options
  );
...
>(
  ...
  useQuery<SablierStreamsQuery, TError, TData>(
    ...
    fetcher<SablierStreamsQuery, SablierStreamsQueryVariables>(
      SablierStreamsDocument,
      variables
    ),
    options
  );
...
>(
  ...
  useQuery<SingleRandomWinnerPrizeStrategyQuery, TError, TData>(
    ...
    fetcher<
      SingleRandomWinnerPrizeStrategyQuery,
      SingleRandomWinnerPrizeStrategyQueryVariables
    >(SingleRandomWinnerPrizeStrategyDocument, variables),
    options
  );
...
>(
  ...
  useQuery<StakePrizePoolQuery, TError, TData>(
    ...
    fetcher<StakePrizePoolQuery, StakePrizePoolQueryVariables>(
      StakePrizePoolDocument,
      variables
    ),
    options
  );
...
export const useVolumeDripQuery = <TData = VolumeDripQuery, TError = unknown>(
  ...
  useQuery<VolumeDripQuery, TError, TData>(
    ...
    fetcher<VolumeDripQuery, VolumeDripQueryVariables>(
      VolumeDripDocument,
      variables
    ),
    options
...
export const useVolumeDripsQuery = <TData = VolumeDripsQuery, TError = unknown>(
  ...
  useQuery<VolumeDripsQuery, TError, TData>(
    ...
    fetcher<VolumeDripsQuery, VolumeDripsQueryVariables>(
      VolumeDripsDocument,
      variables
    ),
    options
